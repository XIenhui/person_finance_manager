  ...
  <div class="account-management-page">
    ...
    <el-card class="table-card com-table">
      ...
      >
        ...
        <el-table-column prop="typeName" label="账户类型" min-width="240">
          <template #default="{ row }">
            ...
            />
            <el-tag v-if="row.is_digital" size="small" effect="plain" style="margin-left: 8px">
              电子
            </el-tag>
            <el-tag
        ...
        <el-table-column prop="institution" label="所属机构" min-width="160" />
...
<script setup>
  ...
  import { reqList, reqAdd, reqDetail, reqEdit, reqDelete, reqChangeStatus } from './api.ts';
    ...
    try {
      await ElMessageBox.confirm(
        `确定要删除账户 "${row.account_name}" 吗？${
          row.balance !== 0 ? '该账户余额不为零，删除后相关交易记录将无法关联！' : ''
        }`,
        '提示',
        {
          type: 'warning',
